...
####### from class as example!!! (get rid of later)
...
# test if apparent resistivities generated from halfspace model is less than 5 % error
def test_halfspace_app_res_error():
